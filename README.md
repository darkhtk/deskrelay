...
화면별 사용 설명은 [매뉴얼](docs/MANUAL.md)을 확인하세요. 이 문서는 v0.0.0 기준입니다.

## 사용 예시

<p>
  <img src="docs/assets/screenshots/usage-mobile-chat.png" alt="모바일 채팅 화면" width="140">
  <img src="docs/assets/screenshots/usage-mobile-sessions.png" alt="모바일 세션 목록" width="140">
  <img src="docs/assets/screenshots/usage-mobile-permissions.png" alt="모바일 권한 탭" width="140">
  <img src="docs/assets/screenshots/usage-mobile-instructions.png" alt="모바일 지침 탭" width="140">
  <img src="docs/assets/screenshots/usage-mobile-skills.png" alt="모바일 스킬 탭" width="140">
</p>
...
- 설정의 `일반` 탭에서 테마, 채팅 글자 크기, 표시 옵션을 다룹니다.
- 설정의 `업데이트` 탭에서 서버와 등록된 connector 업데이트를 다룹니다.
- 설정의 `디바이스`, `연결 진단`, `지침`, `도움말` 탭에서 등록/상태/지침을 확인합니다.

## 업데이트

앱 안에서는 `설정 -> 업데이트 -> 전체 업데이트`를 사용합니다. 서버와 등록된 connector를 함께 갱신하며, 꺼져 있거나 닿지 않는 디바이스는 업데이트 대기 상태로 기록됩니다. 해당 디바이스가 다시 온라인이 되어 진단에 응답하면 서버가 대기 중인 connector 업데이트를 자동으로 재시도합니다.
